...
- Policies for access and use of resources are defined using smart contracts within the Ocean Enterprise framework, enabling the application of usage restrictions and traceability of the processing carried out.

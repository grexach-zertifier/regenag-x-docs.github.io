...
Además, los mecanismos de monetización proporcionados por Ocean Enterprise se están probando para evaluar diferentes mecanismos de incentivos que hacen que el caso de uso sea sostenible más allá de la fase actual de prueba de concepto.
